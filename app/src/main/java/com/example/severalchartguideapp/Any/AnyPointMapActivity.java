...
//https://github.com/AnyChart/AnyChart-Android/blob/master/sample/src/main/java/com/anychart/sample/charts/PointMapActivity.java
public class AnyPointMapActivity  extends AnyChartActivity{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_anypointmap);

        AnyChartView anyChartView = findViewById(R.id.any_point_map);
        ...
        series.type("DIAMOND"); // 마커 모양(https://api.anychart.com/v8/anychart.enums.MarkerType) 참조
