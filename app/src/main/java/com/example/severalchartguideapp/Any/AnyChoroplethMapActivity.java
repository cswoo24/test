...
//https://github.com/AnyChart/AnyChart-Android/blob/master/sample/src/main/java/com/anychart/sample/charts/ChoroplethMapActivity.java
//지도 링크
//https://www.anychart.com/products/anymap/gallery/Maps_Choropleth/Wine_Consumption_Map_of_USA.php
public class AnyChoroplethMapActivity extends AnyChartActivity{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_anychoroplethmap);

        AnyChartView anyChartView = findViewById(R.id.any_choropleth_map);
        ...
        anyChartView.addScript("https://cdn.anychart.com/geodata/latest/countries/united_states_of_america/united_states_of_america.js");
        anyChartView.addScript("https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.3.15/proj4.js");
