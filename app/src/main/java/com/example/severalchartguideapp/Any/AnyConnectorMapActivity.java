...
//https://github.com/AnyChart/AnyChart-Android/blob/master/sample/src/main/java/com/anychart/sample/charts/ConnectorMapActivity.java
//지도 링크
//https://www.anychart.com/products/anymap/gallery/Maps_Connectors/Trip_Through_the_UK.php
public class AnyConnectorMapActivity extends AnyChartActivity{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_anyconnectormap);

        AnyChartView anyChartView = findViewById(R.id.any_connector_map);
...
//
        ...
        anyChartView.addScript("https://cdn.anychart.com/geodata/latest/countries/united_kingdom/united_kingdom.js");
