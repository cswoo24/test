...
public class HelMultiLineActivity extends HelloChartActivity {
    ...
    private int numberOfLines = 2; // dataset 수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_helmultiline);


        lineChart = (LineChartView)findViewById(R.id.hel_line_chart1);
